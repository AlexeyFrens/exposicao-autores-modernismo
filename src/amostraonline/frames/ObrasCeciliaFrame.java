...
public class ObrasCeciliaFrame extends javax.swing.JFrame {
    ...
    ImageIcon ImageEspectros = new ImageIcon("espectros.png");
    ImageIcon ImageCriancaAmor = new ImageIcon("crianca-amor.png");
    ImageIcon ImageNuncaMais = new ImageIcon("nunca-mais.png");
    ImageIcon ImageBaladas = new ImageIcon("baladas-rei.png");
    ImageIcon ImageEspirito = new ImageIcon("espirito-vitorioso.png");
    ImageIcon ImageViagem = new ImageIcon("viagem.png");
    ImageIcon ImageBatuque = new ImageIcon("batuque-samba.png");
    ImageIcon ImageFestaLetras = new ImageIcon("festa-letras.png");
    
    //Aqui está sendo criada objetos que são usados para representar uma imagem que será exibida na interface gráfica.
    
    public ObrasCeciliaFrame() {
        initComponents();
